...
" coc
Plug 'neoclide/coc.nvim', {'branch': 'release', 'do': ':CocInstall -sync coc-tsserver coc-styled-components coc-html coc-css coc-omnisharp coc-pyright coc-snippets coc-emmet coc-json coc-flutter coc-angular coc-vetur coc-java coc-json coc-prettier coc-git coc-go coc-clangd coc-rust-analyzer coc-sourcekit coc-kotlin coc-leetcode-fix'}
